...
const MovieForm = () => {
  ...
  const doSubmit = async (movie) => {
    ...
    navigate("/movies"); // equivalent to history.push()
  };
  ...
  return (
    <div>
      ...
      <Form
        formData={movieData}
        formSchema={movieSchema}
        doSubmit={doSubmit}
        submitButton="Save"
      >
        <Input label="Title" name="title" />
        <Select label="Genre" name="genreId" options={genres} />
        <Input label="Number in Stock" name="numberInStock" />
